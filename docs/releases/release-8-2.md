...
The update brought a few enhancements such as [Guest Secure Boot](/guides/guest-UEFI-Secure-Boot#enable-secure-boot-for-a-guest-vm), support for Rocket Lake CPUs, or better log rotation.
